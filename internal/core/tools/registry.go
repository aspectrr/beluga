...
// The concrete Sandbox type in the workspace package implements this.
type SandboxRunner interface {
	Exec(ctx context.Context, cmd string, args ...string) (stdout string, stderr string, exitCode int, err error)
